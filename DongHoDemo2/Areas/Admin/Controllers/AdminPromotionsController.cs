...
namespace DongHoDemo2.Areas.Admin.Controllers
{
    ...
    public class AdminPromotionsController : Controller
    {
        ...
        public AdminPromotionsController(DongHoDemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PromotionId,PromotionName,PromotionPrice")] Promotion promotion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PromotionId,PromotionName,PromotionPrice")] Promotion promotion)
        {
